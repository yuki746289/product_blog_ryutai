...
function graph() {
	...
	//描画コンテキストの取得
	canvas_2 = document.getElementById('canvas_table');
	...
	//キャンバスサイズ
	graph_01 = document.getElementById('table_01');
...
//	テーブル
	...
	//描画コンテキストの取得
	canvas_3 = document.getElementById('canvas_sub');
	...
	//キャンバスサイズ
	table_01 = document.getElementById('graph_01');
