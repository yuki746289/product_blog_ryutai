...
MPS={"mps/mps_1.html":1,"mps/mps_2.html":1,"mps/mps_3.html":12,"mps/mps_4.html":9,
     "mps/mps_5.html":2,"mps/mps_6_1.html":2,"mps/mps_6_2.html":22}
...
def merge(a):
    ...
    if sum(v for v in actual.values() if v>=0)!=49: probs.append("MPS total is not 49")
    ...
    L=["# Final Site Browser QA — 2026-09-19","",f"- Overall: **{status}**","- Browser: Chromium / Playwright",
       ...
       f"- Hard-failure rows: **{len(bad)}**",f"- MPS known missing references: **{sum(v for v in actual.values() if v>=0)}/49**",
    ...
    L += ["","## Acceptance criteria","","- MPS 49 known missing references remain SOURCE BLOCKED / HOLD.","- MathJax errors = 0.",
