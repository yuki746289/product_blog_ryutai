# 数式レビュー: hydronamics/hydronamics_11_6.html

更新日: 2026-09-19

## 対象
- ページ: `hydronamics/hydronamics_11_6.html`
- 正本ディレクトリ: `img/hydronamics_d_ma.files`
- 数式: **2式**
- 新厳密 Pass 1: **2/2**
- 新厳密 Pass 2: **2/2**
- HOLD: **0**
...
## 元画像 ↔ MathJax 直接比較
- Ma=v/c と ∂ρ/∂t≠0 を確認。HTML/JSON差は空白のみで描画内容は一致。
